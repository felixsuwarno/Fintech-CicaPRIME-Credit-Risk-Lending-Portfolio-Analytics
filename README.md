...
**- SQL:**
	...
	- Aggregate monthly realized interest and fee revenue using payment_date -> this should be made into year_month configuration.
...
**- Python:**
	...
	- Run STL decomposition (period=12) and plot the trend/seasonal/residual components to diagnose revenue structure.
